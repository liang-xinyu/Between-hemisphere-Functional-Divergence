...
load([Codes_path,'Data/IFD_6Dinds_s8.mat']);
...
% vertex-based GLM for fluid intelligence
result_slm=cell(1,2);
for i = 1:2
    j=1;
    ...
    result_slm{1,i} = slm_cog;
end


for i=1:2
    obj = plot_slm(result_slm{1,i}, avsurf_hemi, 'mask', HemiMask, 't_colorlimits',[-5,5]);
    pretty_plot(obj)
end


%% vertex-wise mediation
vtsig = result_slm{1,1}.Q'<0.05;
sum(vtsig)
