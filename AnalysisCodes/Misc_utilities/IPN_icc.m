...
%% Computes the interclass correlations for indexing the reliability
%% analysis according to shrout & fleiss' schema.
% INPUT:
%   x   - ratings data matrix, data whose columns represent different
%         ratings/raters & whose rows represent different cases or 
%         targets being measured. Each target is assumed to be a random
